      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-x-3">
          ...
          <Link to="/">
            ...
            <h1
              ...
              className="text-[25px] font-[900]  text-[#313235]"
            >
              Royals Chef
            </h1>
          </Link>
        ...
        <div className="flex text-[#6C4B3F] text-lg justify-between gap-x-3 items-center shrink-0">
          <ul className="hidden md:flex  items-center gap-x-3 ">
            <Link to={"/about"}>
              ...
              <li
                ...
                className={`${active === "About us" && "text-[#f2bc57]"}`}
              >
                About us
              </li>
            </Link>
            <Link to={"/menu"}>
              ...
              <li
                ...
                className={`${active === "Menu" && "text-[#f2bc57]"}`}
              >
                Menu
              </li>
            </Link>
            <Link to={"/blog"}>
              ...
              <li
                ...
                className={`${active === "Blog" && "text-[#f2bc57]"}`}
              >
                Blog
              </li>
            </Link>
            <Link to={"/contact"}>
              ...
              <li
                ...
                className={`${active === "Contacts" && "text-[#f2bc57]"}`}
              >
                Contacts
              </li>
            </Link>
          ...
          <div className="hidden md:flex">
            <button className="px-4 py-2 rounded-[17px] bg-[#f2bc57]">
              Sign Up
            </button>
          </div>
          <div
          ...
          {isSide && (
            <motion.div
              ...
              className="fixed text-[#6C4B3F] rounded-sm left-0 top-0 w-[60%] h-80 bg-white md:hidden"
            >
